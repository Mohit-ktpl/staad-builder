...
export default function ProjectCard({ project, layout = "grid" }) {
  ...
  if (layout === "list") {
    return (
      <Link to={href}>
        <div
          className="flex items-center gap-4 bg-[#242424] p-4 rounded-lg border border-[#2b2b2b] cursor-pointer 
  ...
  return (
    <Link to={href}>
      ...
      >
        {/* THUMBNAIL */}
        <div
          className="bg-white rounded-lg overflow-hidden w-full h-[140px] flex items-center justify-center 
        ...
        <div className="mt-[5px]">
          ...
          <div className="text-gray-400 text-sm mt-[2px] font-light">
            {project.edited}
          </div>
        </div>
      </div>
